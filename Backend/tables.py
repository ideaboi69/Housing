...
class HousingHealthScore(Base):
    ...
    price_vs_market_score = Column(Numeric(5, 2), nullable=False)
    landlord_reputation_score = Column(Numeric(5, 2), nullable=False)
    maintenance_score = Column(Numeric(5, 2), nullable=False)
    lease_clarity_score = Column(Numeric(5, 2), nullable=False)
    amenity_score = Column(Numeric(5, 2), nullable=True)
    proximity_score = Column(Numeric(5, 2), nullable=True)
