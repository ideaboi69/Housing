...
export function getMockBuilding(propertyId: number): BuildingResponse | undefined {
  ...
  return {
    ...
    description:
      "Maple House Residences is a modern student-focused apartment building a 7-minute walk from campus. " +
      "Suites are fully furnished with in-suite laundry, stainless appliances, and high-speed Wi-Fi included. " +
      "Residents get access to a fitness room, study lounges, secure entry, and on-site management — everything you need for a stress-free year close to the University of Guelph.",
