...
export const mockHealthScoreDetails: Record<number, HealthScoreResponse> = {
  1: { listing_id: 1, overall_score: 88, price_vs_market_score: 82, landlord_reputation_score: 94, maintenance_score: 85, lease_clarity_score: 90, created_at: "2026-01-16T00:00:00" },
  2: { listing_id: 2, overall_score: 92, price_vs_market_score: 95, landlord_reputation_score: 91, maintenance_score: 88, lease_clarity_score: 93, created_at: "2026-01-21T00:00:00" },
  3: { listing_id: 3, overall_score: 79, price_vs_market_score: 72, landlord_reputation_score: 94, maintenance_score: 68, lease_clarity_score: 82, created_at: "2026-02-02T00:00:00" },
  4: { listing_id: 4, overall_score: 86, price_vs_market_score: 90, landlord_reputation_score: 78, maintenance_score: 84, lease_clarity_score: 92, created_at: "2026-02-11T00:00:00" },
  5: { listing_id: 5, overall_score: 95, price_vs_market_score: 88, landlord_reputation_score: 98, maintenance_score: 96, lease_clarity_score: 97, created_at: "2026-01-26T00:00:00" },
  6: { listing_id: 6, overall_score: 81, price_vs_market_score: 78, landlord_reputation_score: 76, maintenance_score: 88, lease_clarity_score: 82, created_at: "2026-02-06T00:00:00" },
  7: { listing_id: 7, overall_score: 73, price_vs_market_score: 85, landlord_reputation_score: 70, maintenance_score: 62, lease_clarity_score: 75, created_at: "2026-02-13T00:00:00" },
  8: { listing_id: 8, overall_score: 91, price_vs_market_score: 84, landlord_reputation_score: 96, maintenance_score: 92, lease_clarity_score: 91, created_at: "2026-02-09T00:00:00" },
};
