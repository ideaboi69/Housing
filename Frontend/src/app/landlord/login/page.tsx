      ...
      <div className="relative z-10 min-h-screen px-4 py-8 md:px-6 md:py-10 lg:flex lg:items-center">
        <div className="mx-auto grid w-full max-w-[1180px] items-center gap-10 lg:grid-cols-[minmax(0,1fr)_440px] lg:gap-16">
              ...
              <div className="mt-10 grid max-w-[560px] gap-3 sm:grid-cols-3">
                {[
                  ...
                  <motion.div
                    ...
                    className="rounded-2xl border border-[#1B2D45]/10 bg-white/70 px-4 py-4 text-[#1B2D45]/65 backdrop-blur-sm"
                  >
          ...
          >
            ...
            <div className="rounded-[34px] border border-black/[0.05] bg-white/88 p-6 backdrop-blur-xl md:p-8" style={{ boxShadow: "0 24px 80px rgba(27,45,69,0.10)" }}>
              ...
              <form onSubmit={handleSubmit} className="mt-7 space-y-5">
                ...
                <button
                  ...
                  style={{ fontSize: "15px", fontWeight: 800, boxShadow: "0 10px 24px rgba(255,107,53,0.22)" }}
                >
                  {isLoading ? (
              ...
              <div className="mt-6 text-center">
                <p className="text-[#1B2D45]/40" style={{ fontSize: "13px" }}>
                  New landlord?{" "}
                  <Link href="/landlord/signup" className="text-[#FF6B35]" style={{ fontWeight: 700 }}>
                    Create an account
                  </Link>
                </p>
